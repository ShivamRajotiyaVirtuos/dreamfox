      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <section ref={addToRefs} className="mb-20">
          ...
          <p className="text-gray-300 text-xl leading-relaxed">
            This transformation gave birth to <strong>TEKCORP 2.0</strong>—a future-first, globally brandable name that carries both legacy value and visionary impact.
          </p>
        </section>

        {/* Section 2 */}
        <section ref={addToRefs} className="mb-20">
          <h2 className="text-4xl font-bold mb-6">Brand identity crafted for a modern technology corporation</h2>
          <p className="text-gray-300 text-xl leading-relaxed mb-6">
            DreamFox, the digital + design arm of Virtuos Group, was entrusted with reshaping the brand.
          </p>
          
          <h3 className="text-2xl font-semibold mb-4 text-purple-400">A new identity rooted in TEK but elevated for the future</h3>
          <p className="text-gray-300 text-xl leading-relaxed mb-4">The vision:</p>
          ...
          <h3 className="text-2xl font-semibold mb-4 text-blue-400">A logo that symbolizes precision, engineering & transformation</h3>
          <p className="text-gray-300 text-xl leading-relaxed mb-4">
            DreamFox designed the TEKCORP logo using:
          </p>
          <ul className="text-gray-300 text-xl leading-relaxed space-y-3 ml-8 mb-6">
            <li>• <strong>Virtuos Blue</strong> to signal trust, engineering depth, and intelligence</li>
            <li>• <strong>Vibrant Orange</strong> as a counterpoint for innovation, energy, and experimentation</li>
            <li>• A <strong>three-triangle 'T' emblem</strong>, representing:
        ...
        {/* Section 3 */}
        <section ref={addToRefs} className="mb-20">
          <h2 className="text-4xl font-bold mb-6">Securing TEKCORP's global digital footprint</h2>
          <p className="text-gray-300 text-xl leading-relaxed mb-6">
            To build a brand that could operate globally, DreamFox ensured TEKCORP owned a complete digital identity ecosystem:
          </p>
          <ul className="text-gray-300 text-xl leading-relaxed space-y-3 ml-8 mb-6">
            <li>• <strong>Tekcorp.com</strong> for enterprise presence</li>
            <li>• <strong>Tekcorp.ai</strong> to reflect its emerging leadership in AI systems</li>
        ...
        {/* Section 4 */}
        <section ref={addToRefs} className="mb-20">
          <h2 className="text-4xl font-bold mb-6">A next-generation DXP experience built with modern tech</h2>
          <p className="text-gray-300 text-xl leading-relaxed mb-6">
            DreamFox designed and engineered the TEKCORP digital experience with:
          </p>
          <ul className="text-gray-300 text-xl leading-relaxed space-y-3 ml-8 mb-6">
            <li>• <strong>React JS</strong> for modular, scalable front-end architecture</li>
            <li>• <strong>TailwindCSS</strong> for a responsive, design-token-driven UI system</li>
            <li>• <strong>GSAP animations</strong> for polished micro-interactions and high-end motion design</li>
            <li>• <strong>AWS cloud stack</strong> for global performance and security</li>
          </ul>
          <p className="text-gray-300 text-xl leading-relaxed mb-6">
        ...
        {/* Section 5 */}
        <section ref={addToRefs} className="mb-20">
          <h2 className="text-4xl font-bold mb-6">TEKCORP 2.0: Engineering the future of Robotics, AI & Cloud Infrastructure</h2>
          <p className="text-gray-300 text-xl leading-relaxed mb-6">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-2xl font-semibold mb-3 text-orange-400">1. Agentic AI for Robotics</h3>
              <p className="text-gray-300 text-xl leading-relaxed">
                Developing autonomous systems that learn, decide, and act in real-world industrial environments.
              </p>
            </div>

            <div>
              <h3 className="text-2xl font-semibold mb-3 text-blue-400">2. Cloud + AI Compute Infrastructure</h3>
              <p className="text-gray-300 text-xl leading-relaxed">
                Designing elastic compute environments optimized for AI workloads and enterprise cloud systems.
              </p>
            </div>

            <div>
              <h3 className="text-2xl font-semibold mb-3 text-green-400">3. Engineering with Global Alliances</h3>
              <p className="text-gray-300 text-xl leading-relaxed mb-4">
                TEKCORP is expanding its capabilities through strong alliances with:
              </p>
              <ul className="text-gray-300 text-xl leading-relaxed space-y-2 ml-8">
                <li>• Oracle</li>
                <li>• HP</li>
                <li>• Dell</li>
                <li>• Cisco</li>
        ...
        {/* Section 6 */}
        <section ref={addToRefs} className="mb-20">
          <h2 className="text-4xl font-bold mb-6">A brand built to scale into the next decade</h2>
        ...
        {/* Final Section */}
        <section ref={addToRefs} className="mb-20">
          <h2 className="text-4xl font-bold mb-6">TEKCORP today stands as:</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white/10 border border-gray-600 rounded-lg p-6">
              <p className="text-gray-200 text-lg">A reborn engineering brand</p>
            </div>
            <div className="bg-white/10 border border-gray-600 rounded-lg p-6">
              <p className="text-gray-200 text-lg">A future-first robotics & AI company</p>
            </div>
            <div className="bg-white/10 border border-gray-600 rounded-lg p-6">
              <p className="text-gray-200 text-lg">A strong enterprise identity under VBrand</p>
            </div>
            <div className="bg-white/10 border border-gray-600 rounded-lg p-6">
              <p className="text-gray-200 text-lg">A symbol of modern engineering excellence</p>
            </div>
          </div>
        </section>
      </div>
