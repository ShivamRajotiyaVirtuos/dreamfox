  ...
  return (
    ...
    >
      <div className="container mx-auto h-full flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 px-4 py-8 md:py-0">
        ...
        <div
          ref={cardsWrapperRef}
          className="w-full  h-full relative opacity-0 flex items-center justify-start"
        >
          <div className="relative w-full h-full max-w-none">
            {slides.map((slide, index) => (
              <div
                ...
                className="card w-full h-full rounded-xl bg-gray-800 text-white absolute left-0 top-1/2 -translate-y-1/2 shadow-2xl border border-white/20 p-6 flex flex-col"
                style={{
                  zIndex: 10 + index,
                }}
              >
