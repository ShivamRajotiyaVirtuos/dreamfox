...
const AnimatedCardsSection = () => {
  ...
  const cardsData = [
    {
      ...
      description:
        "Create stunning, responsive websites with modern technologies and frameworks. Our expert team delivers high-performance web solutions.",
    },
    {
      id: 2,
      icon: (
      ...
      description:
        "Transform your data into actionable insights with advanced analytics and visualization tools. Make data-driven decisions that propel your business.",
    },
    {
      id: 3,
      icon: (
        ...
        >
          ...
          <path
            d="M4.22 4.22L7.04 7.04"
            stroke="currentColor"
            strokeWidth="2"
          />
          <path
            d="M16.96 16.96L19.78 19.78"
            stroke="currentColor"
            strokeWidth="2"
          />
          ...
          <path
            d="M4.22 19.78L7.04 16.96"
            stroke="currentColor"
            strokeWidth="2"
          />
          <path
            d="M16.96 7.04L19.78 4.22"
            stroke="currentColor"
            strokeWidth="2"
          />
        </svg>
      ...
      description:
        "Boost your online presence with comprehensive digital marketing strategies. From SEO to social media, we help you reach your target audience.",
    },
    {
      id: 4,
      icon: (
      ...
      description:
        "Scale your business with powerful cloud infrastructure. We provide secure, reliable, and scalable cloud solutions that grow with your business.",
    },
  ];
  ...
  return (
    <div ref={sectionRef} className="py-16 lg:py-36 bg-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 px-4">
          {cardsData.map((card, index) => (
            ...
            >
              ...
              <div
                className="directional-overlay absolute inset-0 bg-white rounded-3xl opacity-0"
                style={{ transform: "scale(0)" }}
              ></div>

              {/* Card Icon */}
              <div className="relative z-10 h-24 flex items-center justify-center p-4">
                <div className="card-icon text-white">{card.icon}</div>
              </div>
