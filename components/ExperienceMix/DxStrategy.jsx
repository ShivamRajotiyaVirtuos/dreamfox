...
const DxStrategy = () => {
    ...
    },
    {
      ...
      diagram: (
        ...
        >
          ...
          <polyline
            points="40,150 80,120 120,100 160,80 200,60 240,40 280,30"
            stroke="url(#grad4)"
            strokeWidth="4"
            fill="none"
          />
      ...
      ScrollTrigger.create({
        ...
        onUpdate: (self) => {
          ...
          sections.forEach((section, index) => {
            ...
            const transforms = {
              opacity: visibility,
              transform: `translateY(${50 * (1 - visibility)}px) scale(${
                0.8 + 0.2 * visibility
              }) rotate(${-10 * (1 - visibility)}deg)`,
            };
            ...
            if (title) {
              ...
              title.style.transform = `translate3d(0, ${
                40 * (1 - visibility)
              }px, 0) scale(${0.9 + 0.1 * visibility})`;
            }

            if (subtitle) {
              subtitle.style.opacity = visibility * 0.9;
              subtitle.style.transform = `translate3d(0, ${
                40 * (1 - visibility)
              }px, 0) scale(${0.9 + 0.1 * visibility})`;
            }
            ...
            if (diagram) {
              ...
              diagram.style.transform = `translate3d(0, ${
                30 * (1 - visibility)
              }px, 0) scale(${0.95 + 0.05 * visibility}) rotate(${
                5 * (1 - visibility)
              }deg)`;
            }
            ...
            features.forEach((feature, featureIndex) => {
              ...
              feature.style.transform = `translate3d(0, ${
                20 * (1 - featureProgress)
              }px, 0) scale(${0.98 + 0.02 * featureProgress})`;
            });
  ...
  const animateSVGElements = (section) => {
    ...
    const elements = svg.querySelectorAll(
      "rect, circle, path, polyline, polygon, line"
    );
            ...
            <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-12 lg:gap-24 items-center">
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  ...
                  <p
                    className="section-subtitle text-20 text-gray-300 leading-relaxed"
                    style={{ willChange: "transform" }}
                  >
                    {item.subtitle}
                  </p>
                  ...
                  <div className="flex space-x-2">
                    {timelineData.map((_, i) => (
                      <div
                        ...
                        style={{
                          backgroundColor:
                            i <= index ? item.bgColor : "#ffffff30",
                          boxShadow:
                            i <= index ? `0 0 10px ${item.bgColor}60` : "none",
