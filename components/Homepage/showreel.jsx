...
//                         ${
//                           hoveredCard === project.id
//                             ? "transform -rotate-3 translate-y-16  sm:translate-y-16 rounded-3xl     z-10"
...
//                     >
//                       {/* Project Image */}
//                       <div className="h-auto sm:h-[28rem] overflow-hidden relative">
//                         <img
//                           src={project.image}
//                           alt={project.title}
...
//                         )}
//                         {hoveredCard !== project.id && (
//                           <div className="p-4 hidden lg:block absolute bottom-0">
            ...
            {projects.map((project) => (
              ...
              >
                <div className="relative flex items-center group cursor-pointer">
                  {/* Card Container with proper stacking */}
                  <div
                    className="relative w-full h-[24rem] sm:h-[24rem] md:h-[28rem] transform-gpu"
                    onMouseEnter={() => {
                      handleCardHover(project.id, true);
                      swiperRef.current?.autoplay?.stop();
                    }}
                  ...
                  >
                    {/* Folder Image - Fixed z-index and positioning */}
                    <div 
                      className={`absolute -bottom-24 sm:-bottom-20 left-0 right-0 transform-gpu transition-all duration-700 ease-out ${
                        hoveredCard === project.id
                          ? "translate-y-8 opacity-100 scale-100"
                          : "translate-y-8 2xl:translate-y-0 opacity-100 2xl:opacity-0 scale-100"
                      }`}
                      style={{ 
                        zIndex: 50,
                    ...
                    >
                      <Image
                        className="w-full h-auto opacity-100 transform-gpu"
                        src={"/images/folder.svg"}
                        height={300}
                        width={500}
                        alt="Folder"
                    ...
                    <div 
                      className="absolute -bottom-20 left-0 right-0 p-4 transform-gpu"
                      style={{ 
                        zIndex: 60,
                        willChange: 'transform, opacity'
                      }}
                    ...
                    {/* Project Image Container - Fixed positioning and transforms */}
                    <div
                      className={`absolute inset-6 rounded-3xl shadow-lg transform-gpu transition-all duration-500 ease-out ${
                        hoveredCard === project.id
                          ? "rotate-[-3deg] translate-y-16 sm:-translate-y-8"
                          : "rotate-0 translate-y-20 sm:translate-y-0"
                      }`}
                      style={{ 
                        zIndex: 10,
                    ...
                    >
                      ...
                      <div className="h-auto sm:h-[28rem] overflow-hidden relative">
                        ...
                        {hoveredCard !== project.id && (
                          <PlusCircleIcon 
                            className="size-7 lg:block hidden absolute top-4 right-4 text-white transition-opacity duration-300" 
                            style={{ zIndex: 15 }}
                          />
                        )}
                        ...
                        {hoveredCard !== project.id && (
                          <div 
                            className="p-4 hidden lg:block absolute bottom-0"
                            style={{ zIndex: 15 }}
                          >
                            <h3 className="text-20 bg-white backdrop-blur-sm rounded-full px-5 py-1 font-semibold text-black mb-2 line-clamp-2">
                              {project.title}
