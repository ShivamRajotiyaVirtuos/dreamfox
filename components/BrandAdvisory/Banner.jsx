...
const Banner_Brand = () => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={circle1Ref}
        className="absolute top-[-50vw] right-[-30vw] w-[60vw] h-[60vw] rounded-full bg-gradient-to-bl from-[#4a90e2] to-[#1e3a8a] via-[#000000] z-0"
      />
      <div
        ref={circle2Ref}
        className="absolute top-[-50vw] right-[-30vw] w-[50vw] h-[50vw] rounded-full bg-gradient-to-bl from-[#3b82f6] to-[#1d4ed8] via-[#6b7280] z-0"
      />
      <div
        ref={circle3Ref}
        className="absolute top-[-50vw] right-[-30vw] w-[40vw] h-[40vw] rounded-full bg-gradient-to-bl from-[#60a5fa] to-[#2563eb] via-[#6b7280] z-0"
      />
