...
const Cta = () => {
  ...
  return (
    <>
      ...
      <section
        ref={sectionRef}
        className="relative py-20 lg:py-40 w-screen flex flex-col items-center justify-center p-8 overflow-hidden m-0 bg-gradient-to-br from-pink-900 via-pink-950 to-pink-900"
      >
        ...
        <div className="relative z-10 max-w-4xl text-center">
          ...
          >
            Would you like to engage with YippeeMedia
          </h2>
