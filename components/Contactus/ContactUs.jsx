...
export default function ContactUs() {
  ...
  return (
    ...
    >
      ...
      {/* Main Content */}
      <div className="flex items-center justify-between gap-10 max-w-7xl mx-auto px-6 py-24 relative z-10 min-h-screen">
        ...
        <div ref={leftSideRef} className="flex-1 max-w-lg">
          ...
          <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">john.approv@gmail.com</p>
                    </div>
                  </div>
            ...
            {/* Phone Card */}
            <div className="group relative">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-[#D2448D]/50 via-[#DC6263]/50 to-[#D2448D]/50 rounded-2xl blur opacity-30 group-hover:opacity-70 transition duration-500"></div>
              <div className="relative bg-white/10 backdrop-blur-2xl border border-white/20 rounded-2xl px-6 py-4 hover:bg-white/15 transition-all duration-500 cursor-pointer shadow-xl">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div className="w-14 h-14 bg-gradient-to-r from-[#D2448D] to-[#DC6263] rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                      <svg
                        className="w-7 h-7 text-white"
                        fill="none"
                        stroke="currentColor"
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">(501) 555-4567</p>
                    </div>
                  </div>
                  <div className="w-10 h-10 bg-white/10 backdrop-blur-xl rounded-full flex items-center justify-center group-hover:bg-white/20 transition-colors border border-white/20">
                    <svg
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">Crosby Street, NY, US</p>
                    </div>
                  </div>
                  <div className="w-10 h-10 bg-white/10 backdrop-blur-xl rounded-full flex items-center justify-center group-hover:bg-white/20 transition-colors border border-white/20">
                    <svg
        ...
        <div
          ref={formRef}
          className="flex-1 max-w-2xl ml-12 h-full flex items-center"
        >
